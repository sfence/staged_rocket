...
function rocket.physics(self)
  ...
  while surfnode and (surfnode.drawtype == 'liquid' or surfnode.drawtype == 'flowingliquid') or (surfnode.drawtype=="airlike") do
...
--    local balance = self.buoyancy*self.height
    ...
    mobkit.set_acceleration(self.object,
      ...
      {x=-vel.x*self.water_drag,y=vel.y*self.water_drag,z=-vel.z*self.water_drag})
  else
